...
# Section Day/Time: Section 4 Thur 3-4pm
# People you worked with: Mallory Robbins
...
def task0():
    print("Name: Madi Willihnganz")
    print("My expected score is 95")
...
def name_counts(names):
    ...
    for name in names:
        if name in dictionary:
            ...
            dictionary[name] = 1
    tup = list(dictionary.items())
    tup1 = sorted(tup, key = lambda x: (-x[1], x[0]))
    return tup1
